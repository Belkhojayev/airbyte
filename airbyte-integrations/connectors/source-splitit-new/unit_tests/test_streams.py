...
import pytest
from source_splitit_new.source import SplititNewStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SplititNewStream, "path", "v0/example_endpoint")
    mocker.patch.object(SplititNewStream, "primary_key", "test_primary_key")
    mocker.patch.object(SplititNewStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = SplititNewStream()
